...
// O nome do seu arquivo � ToolUIHandler.cs, mas a classe � EquippedToolUIHandler <-- meu mano copilot julgou o nome da classe
public class EquippedToolUIHandler : MonoBehaviour
{
    ...
    private void UpdateToolUI(ToolInstanceHandler tool)
    {
        ...
        if (currentTool != null)
        {
            ...
            // Verifica se a ferramenta equipada � uma inst�ncia de Sambura.
            if (currentTool is SamburaInstanceHandler sambura)
            {
                // Se for uma Sambura, exibe a informa��o de capacidade.
                ToolText.text = $"{sambura.Data.toolName} ({sambura.occupiedSpace}/{sambura.maxCapacity})";
                // A barra de preenchimento (ScrollUtil) reflete o espa�o ocupado.
        ...
        else
        {
            ...
            image.sprite = null; // Opcional: Limpar o �cone se n�o houver ferramenta
