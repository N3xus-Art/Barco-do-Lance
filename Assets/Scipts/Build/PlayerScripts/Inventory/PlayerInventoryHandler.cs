...
public class PlayerInventoryHandler : MonoBehaviour
{
    ...
    #region Gerenciamento de Invent�rio (Adicionar, Remover)
    ...
    public void EquipToolByType(ToolType type)
    {
        ...
        {
            Debug.Log($"Nenhuma ferramenta do type {type} encontrada no invent�rio.");
        }
    }

    // --- Wrappers para bot�es da Unity ---
    ...
    #region A��es com Ferramentas (Usar, Comprar, Melhorar, Descartar)
    ...
    public void UpgradeEquippedTool()
    {
        ...
        {
            Debug.LogError($"N�o foi poss�vel encontrar o ToolData para o pr�ximo n�vel em: {resourcePath}");
            return;
        }
        ...
        Debug.Log($"Ferramenta {currentToolData.toolName} atualizada para o n�vel {nextLevel}!");
        RaiseInventoryChanged();
    }
    ...
    public bool TryBuyTool(ToolDataHandler data, out ToolInstanceHandler instance)
    {
        ...
        {
            Debug.LogWarning("Falha na compra: pr�-requisitos n�o atendidos.");
            return false;
        }
    ...
    public bool TryCaptureAnimal(ICapturable animal)
    {
        ...
        else
        {
            ...
            {
                Debug.Log("Falhou em capturar na m�o. O animal vai escapar.");
